...
class BotHandlers:
    ...
    """
    def on_action_bar(self, jsonMsg: ChatMessage) -> None: ...
    def on_block_break_progress_end(self, block: Block) -> None: ...
    def on_block_break_progress_observed(
        self, block: Block, destroyStage: float
    ) -> None: ...
    def on_block_update(self, oldBlock: Block | None, newBlock: Block) -> None: ...
    def on_block_update_x_y_z(
        self, oldBlock: Block | None, newBlock: Block | None
    ) -> None: ...
    def on_boss_bar_created(self, bossBar: object) -> None: ...
    def on_boss_bar_deleted(self, bossBar: object) -> None: ...
    def on_boss_bar_updated(self, bossBar: object) -> None: ...
    ...
    def on_chest_lid_move(
        self, block: Block, isOpen: float, block2: Block | None
    ) -> None: ...
    ...
    def on_kicked(self, reason: str, loggedIn: bool) -> None: ...
    ...
    def on_piston_move(
        self, block: Block, isPulling: float, direction: float
    ) -> None: ...
    ...
    def on_resource_pack(
        self, url: str, hash: str | None, uuid: str | None
    ) -> None: ...
    ...
    def on_sound_effect_heard(
        self, soundName: str, position: Vec3, volume: float, pitch: float
    ) -> None: ...
    ...
    def on_title(self, text: str, type: Literal["subtitle", "title"]) -> None: ...
    def on_unmatched_message(self, stringMsg: str, jsonMsg: ChatMessage) -> None: ...
