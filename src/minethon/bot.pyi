...
type ChatLevel = Literal["enabled", "commandsOnly", "disabled"]
type ViewDistance = Literal["far", "normal", "short", "tiny"] | float
type MainHands = Literal["left", "right"]
type LevelType = Literal[
    "default", "flat", "largeBiomes", "amplified", "customized", "buffet", "default_1_1"
]
type GameMode = Literal["survival", "creative", "adventure", "spectator"]
type Dimension = Literal["the_nether", "overworld", "the_end"]
type Difficulty = Literal["peaceful", "easy", "normal", "hard"]
type ControlState = Literal[
    "forward", "back", "left", "right", "jump", "sprint", "sneak"
]
type EquipmentDestination = Literal["hand", "head", "torso", "legs", "feet", "off-hand"]
...
type _OnEvent_chat = Callable[
    [str, str, str | None, ChatMessage, list[str] | None], None
]
type _OnEvent_whisper = Callable[
    [str, str, str | None, ChatMessage, list[str] | None], None
]
type _OnEvent_actionBar = Callable[[ChatMessage], None]
type _OnEvent_error = Callable[[Exception], None]
type _OnEvent_message = Callable[[ChatMessage, str], None]
type _OnEvent_messagestr = Callable[[str, str, ChatMessage], None]
type _OnEvent_unmatchedMessage = Callable[[str, ChatMessage], None]
type _OnEvent_inject_allowed = Callable[[], None]
type _OnEvent_login = Callable[[], None]
type _OnEvent_spawn = Callable[[], None]
type _OnEvent_respawn = Callable[[], None]
type _OnEvent_game = Callable[[], None]
type _OnEvent_title = Callable[[str, Literal["subtitle", "title"]], None]
type _OnEvent_rain = Callable[[], None]
type _OnEvent_time = Callable[[], None]
type _OnEvent_kicked = Callable[[str, bool], None]
type _OnEvent_end = Callable[[str], None]
type _OnEvent_spawnReset = Callable[[], None]
type _OnEvent_death = Callable[[], None]
type _OnEvent_health = Callable[[], None]
type _OnEvent_breath = Callable[[], None]
type _OnEvent_entitySwingArm = Callable[[Entity], None]
type _OnEvent_entityHurt = Callable[[Entity, Entity], None]
type _OnEvent_entityDead = Callable[[Entity], None]
type _OnEvent_entityTaming = Callable[[Entity], None]
type _OnEvent_entityTamed = Callable[[Entity], None]
type _OnEvent_entityShakingOffWater = Callable[[Entity], None]
type _OnEvent_entityEatingGrass = Callable[[Entity], None]
type _OnEvent_entityHandSwap = Callable[[Entity], None]
type _OnEvent_entityWake = Callable[[Entity], None]
type _OnEvent_entityEat = Callable[[Entity], None]
type _OnEvent_entityCriticalEffect = Callable[[Entity], None]
type _OnEvent_entityMagicCriticalEffect = Callable[[Entity], None]
type _OnEvent_entityCrouch = Callable[[Entity], None]
type _OnEvent_entityUncrouch = Callable[[Entity], None]
type _OnEvent_entityEquip = Callable[[Entity], None]
type _OnEvent_entitySleep = Callable[[Entity], None]
type _OnEvent_entitySpawn = Callable[[Entity], None]
type _OnEvent_entityElytraFlew = Callable[[Entity], None]
type _OnEvent_usedFirework = Callable[[], None]
type _OnEvent_itemDrop = Callable[[Entity], None]
type _OnEvent_playerCollect = Callable[[Entity, Entity], None]
type _OnEvent_entityAttributes = Callable[[Entity], None]
type _OnEvent_entityGone = Callable[[Entity], None]
type _OnEvent_entityMoved = Callable[[Entity], None]
type _OnEvent_entityDetach = Callable[[Entity, Entity], None]
type _OnEvent_entityAttach = Callable[[Entity, Entity], None]
type _OnEvent_entityUpdate = Callable[[Entity], None]
type _OnEvent_entityEffect = Callable[[Entity, Effect], None]
type _OnEvent_entityEffectEnd = Callable[[Entity, Effect], None]
type _OnEvent_playerJoined = Callable[[Player], None]
type _OnEvent_playerUpdated = Callable[[Player], None]
type _OnEvent_playerLeft = Callable[[Player], None]
type _OnEvent_blockUpdate = Callable[[Block | None, Block], None]
type _OnEvent_blockUpdate__x__y__z_ = Callable[[Block | None, Block | None], None]
type _OnEvent_chunkColumnLoad = Callable[[Vec3], None]
type _OnEvent_chunkColumnUnload = Callable[[Vec3], None]
type _OnEvent_soundEffectHeard = Callable[[str, Vec3, float, float], None]
type _OnEvent_hardcodedSoundEffectHeard = Callable[
    [float, float, Vec3, float, float], None
]
type _OnEvent_noteHeard = Callable[[Block, Instrument, float], None]
type _OnEvent_pistonMove = Callable[[Block, float, float], None]
type _OnEvent_chestLidMove = Callable[[Block, float, Block | None], None]
type _OnEvent_blockBreakProgressObserved = Callable[[Block, float], None]
type _OnEvent_blockBreakProgressEnd = Callable[[Block], None]
type _OnEvent_diggingCompleted = Callable[[Block], None]
type _OnEvent_diggingAborted = Callable[[Block], None]
type _OnEvent_move = Callable[[Vec3], None]
type _OnEvent_forcedMove = Callable[[], None]
type _OnEvent_mount = Callable[[], None]
type _OnEvent_dismount = Callable[[Entity], None]
type _OnEvent_windowOpen = Callable[[Window], None]
type _OnEvent_windowClose = Callable[[Window], None]
type _OnEvent_sleep = Callable[[], None]
type _OnEvent_wake = Callable[[], None]
type _OnEvent_experience = Callable[[], None]
type _OnEvent_physicsTick = Callable[[], None]
type _OnEvent_physicTick = Callable[[], None]
type _OnEvent_scoreboardCreated = Callable[[object], None]
type _OnEvent_scoreboardDeleted = Callable[[object], None]
type _OnEvent_scoreboardTitleChanged = Callable[[object], None]
type _OnEvent_scoreUpdated = Callable[[object, float], None]
type _OnEvent_scoreRemoved = Callable[[object, float], None]
type _OnEvent_scoreboardPosition = Callable[[str, object], None]
type _OnEvent_teamCreated = Callable[[object], None]
type _OnEvent_teamRemoved = Callable[[object], None]
type _OnEvent_teamUpdated = Callable[[object], None]
type _OnEvent_teamMemberAdded = Callable[[object], None]
type _OnEvent_teamMemberRemoved = Callable[[object], None]
type _OnEvent_bossBarCreated = Callable[[object], None]
type _OnEvent_bossBarDeleted = Callable[[object], None]
type _OnEvent_bossBarUpdated = Callable[[object], None]
type _OnEvent_resourcePack = Callable[[str, str | None, str | None], None]
type _OnEvent_particle = Callable[[object], None]
...
class Bot:
    ...
    swingArm: Callable[[Literal["left", "right"] | None, bool | None], None]
