...
while True:
    if bot.get_block(39, 63, -403) == "glass":
        ...
        elif (bot.get_block_property(40, 66, -406, "lit") == 0 and 
               bot.get_block_property(38, 66, -406, "lit") == 0 and 
               bot.get_block_property(36, 66, -406, "lit") == 0 and 
               bot.get_block_property(42, 66, -406, "lit") == 0):
            flag = True
